  ...
  const works = [
    {
      ...
      description: `A web application built on a RESTful API architecture to
                  ...
                  data protection.`,
      image:
        "https://res.cloudinary.com/djdnlogf1/image/upload/v1737475216/ycdirectory_lwzasu.png",
      image_width: 600,
      image_height: 400,
      image_alt: "YCDirectory Next.js Course",
      link: "https://ycdirectory.vercel.app/",
      tech: `Next.js, React, TypeScript, Lucide, Sanity, Next-Auth, Vercel,
